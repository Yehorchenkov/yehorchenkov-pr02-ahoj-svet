...
st.write(f"Vyrali ste cislo {cislo}")
...
# upload_obrazok = st.file_uploader(
#     "Nahrajte obrazok: ", 
#     type=["jpg", "jpeg", "png"]
# )
...
if volba == "Akcne":
    ...
    st.write("Vybrali si komedie filmy")
else:
    st.write("Vybrali si drama filmy")
...
# Zobrazenie obrázku
st.image(
    "https://eurocc.nscc.sk/wp-content/uploads/2020/12/CC_EURO-_logo_gold-1.png", 
    caption='Logo NSC'
)
...
with st.expander("Kliknite sem pri viac informacii"):
